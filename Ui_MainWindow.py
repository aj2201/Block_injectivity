...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.text_enter_blocks = QtGui.QWidget()
        self.text_enter_blocks.setEnabled(False)
        self.text_enter_blocks.setGeometry(QtCore.QRect(0, 0, 741, 375))
        self.text_enter_blocks.setObjectName(_fromUtf8("text_enter_blocks"))
        self.verticalLayout_4 = QtGui.QVBoxLayout(self.text_enter_blocks)
        self.verticalLayout_4.setObjectName(_fromUtf8("verticalLayout_4"))
        self.blocks_list_input_text = QtGui.QTextEdit(self.text_enter_blocks)
        self.blocks_list_input_text.setObjectName(_fromUtf8("blocks_list_input_text"))
        self.verticalLayout_4.addWidget(self.blocks_list_input_text)
        self.horizontalLayout_7 = QtGui.QHBoxLayout()
        self.horizontalLayout_7.setObjectName(_fromUtf8("horizontalLayout_7"))
        self.read_from_file_button = QtGui.QPushButton(self.text_enter_blocks)
        self.read_from_file_button.setObjectName(_fromUtf8("read_from_file_button"))
        self.horizontalLayout_7.addWidget(self.read_from_file_button)
        self.verticalLayout_4.addLayout(self.horizontalLayout_7)
        self.toolBox.addItem(self.text_enter_blocks, _fromUtf8(""))
        self.select_blocks_list = QtGui.QWidget()
        self.select_blocks_list.setEnabled(True)
        self.select_blocks_list.setGeometry(QtCore.QRect(0, 0, 106, 111))
        self.select_blocks_list.setObjectName(_fromUtf8("select_blocks_list"))
        self.verticalLayout_7 = QtGui.QVBoxLayout(self.select_blocks_list)
        self.verticalLayout_7.setObjectName(_fromUtf8("verticalLayout_7"))
        self.verticalLayout_5 = QtGui.QVBoxLayout()
        self.verticalLayout_5.setObjectName(_fromUtf8("verticalLayout_5"))
        self.select_all_check_box = QtGui.QCheckBox(self.select_blocks_list)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.select_all_check_box.setFont(font)
        self.select_all_check_box.setObjectName(_fromUtf8("select_all_check_box"))
        self.verticalLayout_5.addWidget(self.select_all_check_box)
        self.listView = QtGui.QListView(self.select_blocks_list)
        font = QtGui.QFont()
        font.setPointSize(12)
        ...
        self.toolBox.addItem(self.select_blocks_list, _fromUtf8(""))
        ...
        self.verticalLayout_2.addWidget(self.load_blocks_button)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 286, 486))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.read_from_file_button.setText(_translate("MainWindow", "Read from file", None))
        self.toolBox.setItemText(self.toolBox.indexOf(self.text_enter_blocks), _translate("MainWindow", "Enter blocks list for analysis", None))
        self.select_all_check_box.setText(_translate("MainWindow", "Select all", None))
        self.toolBox.setItemText(self.toolBox.indexOf(self.select_blocks_list), _translate("MainWindow", "Select Blocks", None))
