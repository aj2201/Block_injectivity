...
# Form implementation generated from reading ui file 'PIR_calc.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        spacerItem6 = QtGui.QSpacerItem(32, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        ...
        self.tableView_snapshot = QtGui.QTableView(self.table_out)
        self.tableView_snapshot.setSortingEnabled(True)
        self.tableView_snapshot.setObjectName(_fromUtf8("tableView_snapshot"))
        self.verticalLayout_2.addWidget(self.tableView_snapshot)
        self.horizontalLayout_9 = QtGui.QHBoxLayout()
        self.horizontalLayout_9.setObjectName(_fromUtf8("horizontalLayout_9"))
        spacerItem7 = QtGui.QSpacerItem(40, 20, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.horizontalLayout_9.addItem(spacerItem7)
        self.pushButton_save_table_to_file = QtGui.QPushButton(self.table_out)
        self.pushButton_save_table_to_file.setObjectName(_fromUtf8("pushButton_save_table_to_file"))
        self.horizontalLayout_9.addWidget(self.pushButton_save_table_to_file)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_save_table_to_file.setText(_translate("MainWindow", "Save to file", None))
