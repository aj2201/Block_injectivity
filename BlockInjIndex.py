...
class BlockInjIndex:
    ...
    def blocks_mapping(self, block_name = None):
        ...
        """
        input_table = pd.read_table(self.BlockMappingFile, ";")                                       #reading the file 
        #input_table["cell"]
    ...
    def load_data(self):
        ...
        if False: #__debug__:
            ...
            print "\t*",self.InterpFile
            print "\t*",self.BlockMappingFile
            print "\t*",self.CellMappingFile
